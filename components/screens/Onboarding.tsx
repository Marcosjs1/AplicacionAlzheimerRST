        ...
        <div className="bg-background-light dark:bg-background-dark font-display text-[#111812] dark:text-gray-100 min-h-screen flex flex-col items-center overflow-x-hidden selection:bg-primary selection:text-[#111812]">
            ...
            <main className="flex-1 w-full max-w-md flex flex-col items-center px-6 pb-8 gap-6 z-0">
                ...
                <div className="w-full flex flex-col items-center gap-6 mb-4">
                    ...
                    <p className="text-base text-gray-400 dark:text-gray-600 font-medium text-center">
                        Toca el botón naranja para iniciar
                    </p>
                </div>
            </main>
...
export const RegisterScreen: React.FC = () => {
    ...
    const isFormValid = isNameValid && isBirthDateValid && isEmailValid && isPasswordValid && doPasswordsMatch;
        ...
        <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-white min-h-screen flex flex-col antialiased">
            ...
            <main className="flex-1 flex flex-col w-full max-w-lg mx-auto px-6 pt-4 pb-8">
                ...
                <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                    ...
                    <div className="pt-6">
                        <button 
                            ...
                            className={`w-full h-16 text-white text-xl font-bold rounded-full shadow-lg transition-all flex items-center justify-center gap-2 ${isFormValid ? 'bg-primary hover:bg-primary-dark shadow-primary/30 active:scale-[0.98] cursor-pointer' : 'bg-gray-300 dark:bg-gray-700 shadow-none cursor-not-allowed opacity-70'}`} 
                            type="submit"
                        >
                ...
                <div className="mt-8 text-center space-y-4">
                    ...
                    <button onClick={() => navigate('/home')} className="text-primary hover:text-white dark:hover:text-white font-semibold text-lg py-2 px-6 rounded-full border border-primary/20 hover:bg-primary transition-colors">
                        Iniciar Sesión
                    </button>
                </div>
            </main>
